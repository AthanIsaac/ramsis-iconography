      ...
      <section className="page-section">
        <div className="section-content">
          <div className="contact-info-grid">
            <div className="contact-info-col animate-in">
              ...
              <ul className="contact-detail-list">
                <li>
                  ...
                  <a href="mailto:ramsis.icons@gmail.com">ramsis.icons@gmail.com</a>
                </li>
                <li>
                  ...
                  <a href="tel:+14253456483">(425) 345-6483</a>
                </li>
                <li>
            ...
            <div className="contact-info-col animate-in" style={{ transitionDelay: '0.1s' }}>
              <span className="section-label">Timeline</span>
              <h3>Commission Process</h3>
              <ul className="timeline-list">
                <li>
                  <span className="tl-label">Personal Icons</span>
                  <span className="tl-duration">4–8 weeks</span>
                </li>
                <li>
                  <span className="tl-label">Church Projects</span>
                  <span className="tl-duration">3–12 months</span>
                </li>
                <li>
                  <span className="tl-label">Iconostasis</span>
                  <span className="tl-duration">6–18 months</span>
                </li>
              </ul>
            </div>

            <div className="contact-info-col animate-in" style={{ transitionDelay: '0.2s' }}>
